...
import cocktail1 from '../../assets/images/cocktail.png'
  ...
  return (
    <div className="min-h-[500px]  flex items-center justify-center  ">
      <div className="relative p-4 min-h-80 md:w-[80%] w-[100%] pb-40  border  border-gray m-20">
       <img className="absolute -left-10 -top-32 w-40" src={cocktail2} alt="" />
       
        <img className="absolute right-0 bottom-0 w-40" src={cocktail1} alt="" />
        {menus.length > 0 && (
          <button
